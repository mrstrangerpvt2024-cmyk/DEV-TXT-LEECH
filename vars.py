...
DATABASE_URL = os.environ.get("DATABASE_URL", "mongodb+srv://ugbot31:ugbot1234@cluster0.n1uexk5.mongodb.net/UGxPRO?retryWrites=true&w=majority&appName=Cluster0")  # Add your own atlas db
MONGO_URL = DATABASE_URL  # For auth system

# Owner and Admin Configuration
OWNER_ID = int(os.environ.get("OWNER_ID", "7678862761"))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "7678862761").split()]  # Default to owner ID
